    ...
    <div class="container">
      <div id="aboutPage">
        <Well id="wellLeft" bsSize="large">
          ...
          solutions to a problem. Outside of the workplace, you'll find me at
          the gym, practising karate, solving rubik's cubes and learning
          something new.
          <p />
        ...
        <Well id="wellRight" bsSize="large">
          ...
          <p>
            ...
            <p />
            <strong>Please note:</strong> Page will be edited to reflect my new
            projects and blogs.
          </p>
        </Well>
      </div>
